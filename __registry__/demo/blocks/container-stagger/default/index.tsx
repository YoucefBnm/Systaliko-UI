'use client';
import { ContainerStagger } from '@/__registry__/blocks/container-stagger/default';
import { Badge } from '@/__registry__/shadcn/badge/default';
import { Button } from '@/__registry__/shadcn/button/default';
import { TRANSITIONS } from '@/__registry__/utils/transitions/default';
import { ANIMATION_VARIANTS } from '@/__registry__/utils/animation-variants/default';
