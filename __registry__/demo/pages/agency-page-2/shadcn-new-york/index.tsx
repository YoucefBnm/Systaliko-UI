...
import { ContainerStagger } from '@/__registry__/containers/container-stagger/shadcn-new-york';
import { gridStaggerdVariants } from '@/__registry__/containers/grid-staggered/shadcn-new-york';
import { RatingStars } from '@/__registry__/rating-stars/shadcn-new-york';
import {
  ScrollXCarousel,
  ScrollXCarouselContainer,
  ScrollXCarouselWrap,
} from '@/__registry__/scroll-x-carousel/shadcn-new-york';
