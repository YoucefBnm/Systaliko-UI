...
<ComponentInstallation name="hero-gradient" />
...
>
  <HeroGradientText className="flex flex-col items-center space-y-5">
    <HeroTextBadge className="text-primary" animation="blur">
      <span className="inline-block text-xs">Get started with us &rarr;</span>
    </HeroTextBadge>
    ...
    >
      ...
      sunt necessitatibus, quas, facere iste molestiae alias vel optio delectus
      architecto enim tenetur mollitia? Soluta.
    </HeroDescription>
