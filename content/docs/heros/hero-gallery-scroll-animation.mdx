...
description: Hero section with scroll trigger animations, reversing the scale of the gallery and the text on scroll.
---

<ComponentPreview name="hero-gallery-scroll-animation-demo" />

## Installation

<ComponentInstallation name="hero-gallery-scroll-animation" />
