---
title: Animated Container Inset
description: Scroll triggerd animations, animating inset on x axis, and children transforms.
new: true
---

This component is inspired by [Beyond agency](https://bynd-agency.com/) hero section.

<ComponentPreview name="container-inset-scroll-demo" />

## Installation

<ComponentInstallation name="container-inset-scroll" />
